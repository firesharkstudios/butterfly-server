...
| [CreateAndStartDynamicView](IDatabase/CreateAndStartDynamicView.md)(…) | Convenience method which creates a [`DynamicViewSet`](../Butterfly.Core.Database.Dynamic/DynamicViewSet.md), adds a single [`DynamicView`](../Butterfly.Core.Database.Dynamic/DynamicView.md) to the [`DynamicViewSet`](../Butterfly.Core.Database.Dynamic/DynamicViewSet.md), and starts the [`DynamicViewSet`](../Butterfly.Core.Database.Dynamic/DynamicViewSet.md). (2 methods) |
