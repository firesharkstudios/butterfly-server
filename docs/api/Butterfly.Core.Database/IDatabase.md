...
| [CreateAndStartDynamicViewAsync](IDatabase/CreateAndStartDynamicViewAsync.md)(…) | Convenience method which creates a [`DynamicViewSet`](../Butterfly.Core.Database.Dynamic/DynamicViewSet.md), adds a single [`DynamicView`](../Butterfly.Core.Database.Dynamic/DynamicView.md) to the [`DynamicViewSet`](../Butterfly.Core.Database.Dynamic/DynamicViewSet.md), and starts the [`DynamicViewSet`](../Butterfly.Core.Database.Dynamic/DynamicViewSet.md). (2 methods) |
| [CreateDynamicViewSet](IDatabase/CreateDynamicViewSet.md)(…) | Allows creating a set of [`DynamicView`](../Butterfly.Core.Database.Dynamic/DynamicView.md) instances that publish a single [`DataEventTransaction`](../Butterfly.Core.Database.Event/DataEventTransaction.md) instance with initial data and new [`DataEventTransaction`](../Butterfly.Core.Database.Event/DataEventTransaction.md) instances when data changes. The [`DataEventTransaction`](../Butterfly.Core.Database.Event/DataEventTransaction.md) instances are published to the lambda passed as the *listener*. (2 methods) |
| [CreateFromResourceFileAsync](IDatabase/CreateFromResourceFileAsync.md)(…) | Creates database tables from an embedded resource file by internally calling !:CreateFromText(string) with the contents of the embedded resource file" |
...
| [SelectRowsAsync](IDatabase/SelectRowsAsync.md)(…) | Executes the SELECT statement and return the rows (the SELECT statement may contain vars like @name specified in *vars*) (2 methods) |
