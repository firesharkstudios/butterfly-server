...
| abstract class [BaseWebApi](Butterfly.Core.WebApi/BaseWebApi.md) | Allows receiving API requests via HTTP (inspired by Node.js' Express) |
...
| interface [IWebApi](Butterfly.Core.WebApi/IWebApi.md) | Allows receiving API requests via HTTP (inspired by Node.js' Express) |
