...
| public type | description |
| --- | --- |
| abstract class [BaseChannelConnection](Butterfly.Core.Channel/BaseChannelConnection.md) | Internal interface representing a communications channel from the server to the client (might be implemented via WebSockets, HTTP long polling, etc) |
| abstract class [BaseSubscriptionApi](Butterfly.Core.Channel/BaseSubscriptionApi.md) | Allows clients to subscribe to channels and allows the server to push data to subscribed clients. |
...
| interface [IChannelConnection](Butterfly.Core.Channel/IChannelConnection.md) | Internal interface representing a communications channel from the server to the client (might be implemented via WebSockets, HTTP long polling, etc) |
| interface [ISubscriptionApi](Butterfly.Core.Channel/ISubscriptionApi.md) | Allows clients to subscribe to channels and allows the server to push data to subscribed clients. |
...
| abstract class [BaseWebApi](Butterfly.Core.WebApi/BaseWebApi.md) | Allows receiving API requests via HTTP (inspired by Node.js' Express) by wrapping existing C# web servers. |
...
| interface [IWebApi](Butterfly.Core.WebApi/IWebApi.md) | Allows receiving API requests via HTTP (inspired by Node.js' Express) by wrapping existing C# web servers. |
